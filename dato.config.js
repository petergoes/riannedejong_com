...
module.exports = (dato, root, i18n) => {
  ...
  locales.forEach(locale => {
    ...
    root.createDataFile(`${dataDir}/${locale}/portfolio/index.json`, 'json', portfolioOverview(dato, i18n))
    ...
    dato.portfolios
      ...
      .forEach(item => {
        root.createDataFile(`${dataDir}/${locale}/portfolio/${item.slug}.json`, 'json', portfolioToJson(item, i18n))
      })
...
function portfolioToJson (page, i18n) {
  const { title, subtitle, hasToc, hasShareButton, hasHotjar } = page
